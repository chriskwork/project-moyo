...
const preguntasFrecuentes = [
  {
    ...
    respuesta:
      "Por ahora MOYO sólo está en España por lo que únicamente se pueden introducir números con prefijo español. Si estás interesado en utilizarlo para un negocio ubicado en otro país ponte en contacto con nosotros a través de nuestro email sos@MOYO.com."
  },
  {
    ...
    respuesta: `Comprueba que tu móvil tiene conexión y que el número que has introducido es correcto. Además la plataforma te permite un máximo de 3 envíos durante un tiempo limitado. 
        ...
        Si sigues sin recibir el SMS espera un tiempo de 10 minutos, intenta la acción o ponte en contacto con nosotros a través de nuestro email sos@MOYO.com.`
  },
  {
    pregunta: "¿Qué hago si he olvidado mi contraseña?",
    respuesta:
      "No te preocupes, si has olvidado tu contraseña puedes hacer click en el botón Recordar contraseña. Solo tienes que introducir el email de registro y te enviaremos las instrucciones al correo para que puedas volver a configurar una contraseña"
  },
  {
    pregunta:
      "He recibido un correo electrónico me dice que he creado una nueva cuenta, pero no me he registrado",
    respuesta:
      "Lo más probable es que alguien haya intentado registrar una cuenta de MOYO utilizando tus datos por error. Ponte en contacto con nosotros a través de nuestro email sos@MOYO.com."
  },
  {
    pregunta:
      "Ya tengo una cuenta de MOYO, ¿Puedo entrar con ella en MOYO Business?",
    respuesta:
      "No, MOYO y MOYO Business son dos plataformas diferentes que funcionan con un registro y un inicio de sesión distinto. Si quieres crearte una cuenta en MOYO Business tienes que ponerte en contacto con nosotros a través del email info@MOYO.com."
  },
  {
    pregunta:
      "No he recibido el email de instrucciones para recuperar mi contraseña",
    respuesta: `Espera unos minutos y comprueba la bandeja de spam. Si aún así sigues sin recibirlo es posible que no hayas introducido la dirección correctamente. 
        ...
        En caso de que esté bien y aún así no recibas el email, ponte en contacto con nosotros a través del email sos@MOYO.com.`
  },
  {
    pregunta: "¿Qué hago si me han robado la cuenta o cambiado la contraseña?",
    respuesta:
      "Si no puedes acceder a tu cuenta y crees que te la han robado, escríbenos a sos@MOYO.com y explícanos el problema, nos pondremos en contacto contigo lo antes posible."
  },
  {
    pregunta: "¿Qué es una marca en MOYO?, ¿Y un punto de venta?",
    respuesta: `Una marca en MOYO es la identificación comercial bajo la que se conoce al negocio, mientras que el punto de venta es el lugar físico donde la marca desarrolla su negocio. 
        
        En MOYO es obligatorio crear una marca y luego asociarla a uno o varios puntos de venta. Incluso si solo tienes un punto de venta también es necesario que exista el perfil de marca y el de punto de venta.`
  },
  {
    pregunta: "¿Por qué tengo que añadir un punto de venta a la marca?",
    respuesta: `Por el momento MOYO solo trabaja con marcas que tengan un punto de venta físico, por lo que es obligatorio que la marca tenga asociado un punto de venta real.

        En el caso de que el negocio de tu marca sea la venta online o por cualquier otro motivo no tengas punto de venta físico, por ahora no puedes crearte un perfil en MOYO Business.`
  },
  {
    pregunta: "¿Cuántos puntos de venta puede tener mi marca?",
    respuesta: `MOYO Business te permite gestionar todos los puntos de venta que tenga tu marca.`
  },
  {
    pregunta: "¿Puedo gestionar varias marcas desde el mismo usuario?",
    respuesta: `En MOYO Business puedes gestionar tantas marcas como quieras a través de tu mismo usuario. Puedes crear nuevas marcas o coger el permiso de otras marcas que quieras gestionar.
        ...
        Si por el contrario te registras porque has recibido la invitación de un permiso solo tendrás que completar tus datos de usuario y ya podrás empezar a usar MOYO.
  ...
  },
  {
    ...
    respuesta: `Las categorías están predeterminadas ya por MOYO Business, pero puede que se nos haya pasado alguna. Si has comprobado que tu negocio no encaja en ninguna de las categorías que hay ponte en contacto con nosotros en el email sos@MOYO.com e intentaremos solucionarlo.`
  },
  {
  ...
  {
    pregunta:
      "Estoy teniendo problemas al cargar la foto de perfil/portada de la marca.",
    respuesta: `Si la imagen no se carga o al cargarla no aparece como esperabas probablemente excede de los límites de peso o de medida de MOYO.
  ...
  },
  {
    ...
    respuesta: `Si quieres que los clientes vean las redes sociales de tu perfil de punto de venta, puedes añadir los enlaces de Twitter, Facebook, Youtube e Instagram a través de tu perfil de punto de venta. En caso de no añadir ningún enlace esta opción no se visualizará en tu perfil de MOYO.`
  },
  {
    pregunta: "¿Cómo subo fotos a la galería de un punto de venta?",
    respuesta: `Las fotos que subes en Promociones y Novedades no se quedan en la galería de tu punto de venta. Si quieres que en tu perfil MOYO se queden fijadas las fotos que más te gustan de tu punto de venta, puedes hacerlo a través de tu perfil de punto de venta, en el apartado fotos.`
  },
  {
    pregunta: "¿Qué es un permiso?",
    respuesta: `Puedes añadir a más personas que te ayuden a gestionar tu marca y tus puntos de venta en MOYO Business a través de Permisos. Los permisos pueden ser de administrador de marca y de moderador de puntos de venta.
        ...
        El correo de invitación caduca a los 15 días de enviarse, una vez pasado este plazo, si no ha aceptado el permiso tendrás que volver a añadir el permiso. Si la persona que recibe el permiso no es usuario de MOYO Business tendrá que registrarse primero para acceder al permiso.`
  },
  {
    pregunta:
      "¿Puedo dar permiso a otro perfil para administrar o moderar la marca y sus puntos de venta?",
  ...
  {
    pregunta:
      "¿Qué ocurre si quiero eliminar mi cuenta y soy el único administrador de una marca?",
    respuesta: `Si eliminas tu cuenta de MOYO Business y eres el único administrador de una marca esta también se eliminará, así como todos sus puntos de venta y el contenido que haya subido. Si no quieres que se elimine tendrás que añadir nuevos permisos de administración a otra persona (y que lo acepte) antes de eliminar tu cuenta.`
  },
  {
    pregunta: "¿Qué necesita una persona para usar el permiso que le he dado?",
    respuesta: `En caso de que una persona con cuenta en MOYO Business haya recibido un permiso sobre otra marca, solo tendrá que aceptar el permiso mediante el email que le enviemos a la cuenta que nos haya proporcionado el administrador y se le añadirá a su cuenta. El email de invitación a permisos caducará después de 15 días del envío en caso de que no se acepte.

        En el caso de que la persona aún no tenga cuenta en MOYO Business, se tendrá que registrar en la plataforma con el mismo email con el que ha recibido el permiso y una vez registrado se le asignará el permiso automáticamente.`
  },
  {
    pregunta: "¿Qué es un Partner de MOYO?",
    respuesta: `Un Partner de MOYO es un profesional de la comunicación que gestiona o quiere gestionar alguna marca en MOYO.

        Un Partner es una agencia de comunicación o community manager valoradas por MOYO para ofrecer a las Marcas sus servicios. Un Partner te ayudará con las publicaciones,el contenido y la gestión de tu perfil en MOYO.
        
        Si estás interesado en este servicio, contacta con uno de ellos, él mismo te facilitará sus tarifas, una vez que haya una acuerdo entre ambas partes. Para que trabaje en tu marca solamente necesitarás que te informe del email de su perfil de MOYO y darle el permiso correspondiente desde el bloque de Permisos.`
  },
  {
    pregunta:
      "¿Dónde puedo ver todas las agencias que trabajan como partners de MOYO?",
    respuesta: `Disponemos de un apartado en el footer de la web, con acceso a un listado para que conozcas todas los Partners asociados a MOYO.`
  },
  {
    pregunta: "¿Cómo me buscan los clientes?",
    respuesta: `Los clientes de tu negocio te encuentra a través de app de MOYO. En ella hay diferentes formas en la que pueden encontrarte:

        1. Pueden buscar directamente tu marca y puntos de venta y seguirlos para ver tus publicaciones.
        2. Pueden encontrarte al buscar la categoría de tu negocio cuando están cerca de él. Esto solo pasará en caso de que haya publicado una novedad o promoción en el muro o si alguien ha escrito una experiencia sobre tu negocio. La mayor ventaja de MOYO es que tu publicación solo aparecerá en caso de que la persona esté buscando tu categoría y se encuentre en un radio cercano a alguno de tus puntos de venta.
  ...
  },
  {
    ...
    respuesta: `Las publicaciones que hagas la podrán ver los potenciales clientes a través de la app de MOYO. Pueden encontrarlas en tu perfil de marca y de puntos de venta siempre,, se podrán ver cuando el usuario busque negocios de tu categoría cerca del radio donde se ubica tu punto de venta.`
  },
  {
  ...
  {
    pregunta:
      "Si un usuario deja de seguir a mi punto de venta, ¿puedo seguir viendo su perfil en el CRM?",
  ...
  },
  {
    ...
    respuesta: `Las notificaciones son avisos de que alguien ha interactuado con tu perfil de alguna forma: siguiéndolo, dando a me gusta o comentando una publicación, al recibir una experiencia, recibir un mensaje, cuando se caduca una publicación, cuando se publica una promoción programada o cuando hay alguna modificación en los permisos.
        ...
        Recuerda que MOYO Business solo guarda las notificaciones durante 30 días, después no volverán a aparecer.
...
const docuPrivacidad = [
  {
    ...
    texto: `La aceptación de esta Política de Privacidad significa que el Usuario faculta a SOCIAL NETWORK MOYO, S.A. con NIF A87532826 (en adelante, MOYO o la Titular, indistintamente), y domicilio en Calle Leganitos 47, 4º, 28013, Madrid, como titular de la Plataforma, para tratar los datos personales que el Usuario haya facilitado a MOYO como responsable del tratamiento, para los fines estipulados a continuación:

        Contacto: el Usuario que lo desee puede ponerse en contacto con la Titular a través del formulario habilitado en el Sitio Web a tal efecto. Los datos personales que suministre serán tratados por MOYO para atender la consulta y ponerse en contacto con el usuario.
        ...
        El usuario habrá informado previamente al tercero de la presente Política de Privacidad, del tratamiento que hará MOYO de sus datos.
  ...
  },
  {
    ...
    texto: `Comunicaciones de MOYO: una vez se haya creado la Marca dentro de la Plataforma MOYO, la Titular podrá tratar los datos indicados por el Usuario, para enviarle a la Marca comunicaciones comerciales por correo electrónico, notificaciones push en su navegador, o por otros medios electrónicos similares (como mensaje de texto, por ejemplo), a través de los medios de contacto indicados por el usuario; con el fin de informar sobre novedades de servicio en MOYO u otro tipo de información relacionada con noticias de interés o con la gestión de la Marca en la Plataforma.
        La base jurídica que sustenta este tratamiento es el interés legítimo de MOYO, puesto que se trata de comunicaciones comerciales relacionadas con el servicio que presta al crearse la cuenta de Marca.
        ...
        Newsletter: el Usuario puede, si lo desea, suscribirse a la newsletter de MOYO. Los datos serán tratados para enviarle por email o medios electrónicos similares, información sobre los servicios relacionados con MOYO y otras noticias de interés, así como sobre los servicios y noticias de otras empresas: agencias de comunicación y marketing.
  ...
  },
  {
    ...
    texto: `Los datos facilitados por el Usuario no serán comunicados a terceros. Únicamente serán accesibles a través de la Plataforma MOYO, por todos los usuarios registrados.`
  },
  {
    titulo: "Ejercicio de derechos",
    texto: `El Usuario puede revocar el consentimiento para el tratamiento, haciendo ejercicio de los derechos de acceso, rectificación, supresión, portabilidad, oposición y limitación al tratamiento, poniéndolo en conocimiento de MOYO a través de un correo electrónico dirigido a legal@MOYO.com o indicándolo a la dirección física arriba indicada, señalando como asunto “Protección de Datos”. En ambos casos, la comunicación deberá ir acompañada de cualquier documento oficial que permita la identificación, para evitar el acceso de sus datos por parte de terceros. Por último, el Usuario podrá comunicar cualquier modificación por escrito o solicitar la baja, indicándolo en cualquiera de las direcciones facilitadas.
  ...
  },
  {
    ...
    texto: `MOYO se reserva el derecho de modificar en cualquier momento su política de privacidad, respetando la legislación vigente en materia de protección de datos y previa la debida comunicación a los Interesados.`
  },
  {
...
const docuCookies = [
  ...
  },
  {
    ...
    texto: `MOYO utiliza las cookies estrictamente necesarias y esenciales para optimizar la experiencia del usuario en el Sitio Web, utilizando áreas seguras, opciones personalizadas, etc. Asimismo, MOYO utiliza cookies que recogen datos relativos al análisis de uso de la Web, con la finalidad de mejorar el servicio de cara al usuario, midiendo el uso y el rendimiento de la página.

        El Sitio web también contiene enlaces a redes sociales (como Facebook, Instagram o Twitter). MOYO no controla las cookies utilizadas por estas Web externas. No obstante, para más información sobre las cookies de las redes sociales u otras Webs ajenas, el usuario puede acudir directamente a sus propias políticas de cookies.
        
        En concreto y según su finalidad, MOYO utiliza en el Sitio Web los siguientes tipos de cookies:
        ...
        A continuación, se ofrece un listado que agrupa las cookies empleadas en MOYO, indicando el tipo, origen, finalidad, así como un enlace para que el usuario pueda acceder a las Políticas de Cookies de los distintos sitios web de procedencia.
  ...
  },
  {
    ...
    texto: `En cualquier momento podrás retirar tu consentimiento al uso de cookies desactivando o bloqueando su descarga a través de funciones específicas del navegador que utilices.
        ...
        Si tiene alguna duda, no dude en escribirnos a legal@MOYO.com o a la dirección postal indicada más arriba.`
  }
];
...
const docuTerminos = [
  {
    ...
    texto: `Estas condiciones generales (las “Condiciones Legales”) establecen las advertencias, términos y condiciones aplicables al uso de los medios técnicos que NEXTCHANCE SERVICER, S.L (“Nextchance Servicer”) pone a disposición de los usuarios (los “Usuarios”) en la dirección web https://MOYO.com/ (la “Plataforma Web”) y en las aplicaciones para dispositivos móviles o de otro tipo relacionadas (las “Aplicaciones Móviles”). A efectos de las presentes Condiciones Legales, las referencias a “MOYO” se entenderán efectuadas tanto a la Plataforma Web como a las Aplicaciones Móviles, salvo que otro entendimiento resulte del contexto.
        ...
        <li>
        Dirección de correo electrónico: contact@MOYO.com
        </li>
        </ul>`
  },
  {
    titulo:
      "2. ¿Qué NORMAS COMPONEN mi RELACIÓN CONTRACTUAL CON Nextchance Servicer?",
    texto: `Para el uso de MOYO será necesario el registro, así como la aceptación de las presentes Condiciones Legales y de la Política de Privacidad y de Cookies de MOYO [enlace a la Política de Privacidad y Cookies de MOYO]. Además, resultarán de aplicación a los Usuarios aquellas otras condiciones generales y/o particulares que suscriban con MOYO en relación con la utilización de determinados recursos y/o contenidos puestos a su disposición en MOYO o con ocasión de promociones específicas (tales como períodos de prueba gratuitos o exenciones y reducciones de cuota promocionales para determinados Usuarios).

        Al conjunto de términos y condiciones que resulte de las Condiciones Legales, Política de Privacidad y de Cookies de MOYO y las condiciones generales y particulares que cada Usuario suscriba con MOYO se denominará la “Relación Contractual”. A efectos aclaratorios, no quedarán comprendidas en la Relación Contractual las condiciones que rijan las eventuales relaciones contractuales que establezcan los Usuarios entre sí, a las que MOYO es completamente ajena.
        
        La mera utilización de MOYO conlleva automáticamente la aceptación plena y sin reserva por el Usuario de todas y cada una de las presentes Condiciones Legales en la versión publicada por Nextchance Servicer en cada momento. En consecuencia, el Usuario debe leer periódicamente las Condiciones Legales para conocer sus variaciones, que no necesariamente serán advertidas específicamente a los Usuarios.`
  },
  {
    titulo:
      "3.  ¿cómo funciona MOYO y qué responsabilidad asume Nextchance Servicer?",
    texto: `MOYO es una interfaz digital que permite a terceros independientes de Nextchance Servicer (llamados “Handys” y “Negocios”) ofertar bienes y servicios a precios descontados y a los Usuarios llamados “Billioners” contratar con aquellos la adquisición de tales bienes y servicios. En adelante, se denominará “Transacción” a cada adquisición de bienes o servicios por un Billioner a un Handy o Negocio a través de MOYO.

        Para poder completar una Transacción, los Billioners deberán disponer de los cupones virtuales de descuento que Nextchance Servicer emite de acuerdo con los procedimientos establecidos en estas Condiciones Generales y que se llaman “Bithands”. Cada Bithand da la posibilidad de obtener el equivalente a 1 € de descuento (o, en el caso de aquellas Transacciones que se efectúen en moneda distinta del Euro, el equivalente que en cada momento aparezca publicado en MOYO). Los Bithands usados por los Billioners para obtener esos descuentos serán redimidos en el momento de la Transacción (esto es, se cancelarán en el acto, dándose de baja del saldo existente en el wallet asociado con la cuenta del Billioner y en ningún caso serán transmitidos a los Negocios o Handys).
        
        En MOYO existen dos modalidades de Usuarios:
        
        “Usuarios Particulares” son todas aquellas personas físicas que se registran en MOYO para actuar como “Billioners”, esto es, como consumidores o usuarios finales de los bienes y servicios que ofertan otros Usuarios.
        ...
        Es importante que los Usuarios sepan que Nextchance Servicer no es responsable ni de los anuncios ni de las Transacciones que se efectúan en MOYO. Éstos son iniciativa y responsabilidad de los Handys y Negocios que los realizan y las Transacciones y los pagos a ellas asociados se producirán exclusivamente entre los Usuarios, sin intervención de Nextchance Servicer, cuya función se limita a poner a disposición una plataforma donde los Handys y Negocios anuncian sus productos y servicios y los Billioners pueden adquirirlos y a actualizar el saldo de Bithands del Billioner tras la Transacción.
        ...
        Asimismo, los Billioners deben ser conscientes de que, al igual que ellos, los Handys y Negocios son libres de abandonar MOYO en cualquier momento. Desde ese mismo momento, Handys y Negocios no estarán obligados a atender las peticiones de descuento de los Billioners.`
  },
  {
    titulo:
      "4.  Posición y responsabilidad de Nextchance Servicer en relación con los contenidos de MOYO",
    texto: `Los contenidos subidos a o publicados en MOYO por terceros ajenos a Nextchance Servicer, incluyendo por cualesquiera Usuarios, serán denominados “Contenidos de Usuario”.
        ...
        La oferta y contratación de bienes y servicios en MOYO quedará sujeta a la aceptación por el Billioner de las condiciones generales y/o particulares establecidas por el Handy o Negocio correspondiente, siendo MOYO completamente ajena a las relaciones contractuales que se establezcan entre los Usuarios.
        ...
        Entre otros, Nextchance Servicer no verifica la existencia de poderes de representación ni la suficiencia de los existentes para que un Usuario pueda actuar por cuenta de una determinada persona física o jurídica. Por lo tanto, cada Usuario deberá llevar a cabo un uso diligente y prudente de MOYO interactuando con Usuarios que merezcan su confianza, como lo harían fuera de Internet. La información sobre un Usuario que exista en MOYO (la información de su perfil, las Valoraciones y las experiencias que se publiquen en relación con ese Usuario) no supone garantía por Nextchance Servicer ni exime al Usuario de observar la debida diligencia.
        
        Asimismo, Nextchance Servicer tampoco garantiza, verifica ni asume responsabilidad alguna en relación con el cumplimiento de la normativa tributaria, incluyendo en materia de expedición y conservación de facturas, que incumbe exclusivamente a los Usuarios que ofrezcan productos o servicios a través de MOYO.
  ...
  },
  {
    ...
    texto: `El Usuario se obliga a utilizar MOYO de conformidad con las presentes Condiciones Legales con plena observancia y respeto de la legislación aplicable y de los derechos de terceros asumiendo, además, las siguientes obligaciones:

        7.1. Únicamente creará y utilizará una cuenta de Usuario y un único nombre de Usuario, que será público para todo MOYO e identificará a todos los efectos su operativa en él. Los datos introducidos por el Usuario deberán ser veraces, exactos y actualizados.
        ...
        7.3. Omitirá el empleo de cualquier dato, información o Contenido de Usuario accesible en MOYO para fines distintos del uso de MOYO según lo previsto en la Relación Contractual.
        ...
        7.5. El Usuario será el único responsable del cumplimiento de las obligaciones administrativas, fiscales, laborales o de otro tipo que imponga la legislación vigente para la realización o aceptación de las ofertas de bienes y servicios que lleve a cabo en MOYO, así como de las obligaciones derivadas de la eventual contratación en relación con los referidos bienes y servicios y de cualesquiera daños y perjuicios de naturaleza contractual o extracontractual que eventualmente pudieran ocasionarse con ocasión de las relaciones entre los Usuarios.
        
        7.6. El Usuario reconoce y acepta que MOYO y Nextchance Servicer son ajenos a las eventuales relaciones establecidas entre los Usuarios con ocasión de las ofertas de bienes y servicios publicadas en MOYO y que, por tanto, Nextchance Servicer no asume ninguna responsabilidad por este concepto.
        ...
        7.9. En general, no utilizará MOYO para realizar actividades contrarias a las leyes, a la moral, las buenas costumbres o al orden público. En concreto, y a mero título enunciativo, se abstendrá de:
        ...
        7.9.4. Revelar secretos empresariales o comerciales de otros Usuarios o información confidencial de éstos que le haya sido suministrada en el contexto de su relación en MOYO;
        ...
        7.10. Omitirá el empleo de medios o instrumentos técnicos o informáticos que pudieran impedir o dificultar el normal funcionamiento de MOYO o dañar las herramientas y dispositivos técnicos integrados en MOYO u otros pertenecientes a Nextchance Servicer o a los Usuarios;
        
        7.11. Omitirá el empleo de cualquier herramienta técnica o informática que permita la extracción, automatizada o sustancial, de datos o contenidos alojados o almacenados en o accesibles por medio de MOYO, tales como web crawlers, spiders, etc.`
  }
];
...
const docuContratacion = [
  {
    titulo: "Aviso legal",
    texto: `SOCIAL NETWORK MOYO, S.A. con NIF A87532826 (en adelante, MOYO o la Titular, indistintamente), y domicilio en Calle Leganitos 47, 4º, 28013, Madrid, inscrita en el Registro Mercantil en el Registro Mercantil de Madrid en el Tomo 34654, Folio 50, Sección 8, Hoja 623351, inscripción 1ª es titular del sitio web accesible desde la URL https://business.MOYO.com/ (en adelante, MOYO business o el Sitio Web, indistintamente).

        El objetivo principal de MOYO es conectar a los usuarios entre sí, y con los negocios y establecimientos que formen parte de la comunidad, para que éstos puedan darse a conocer mediante la publicación de sus ofertas, descuentos promocionales y todo tipo de contenido.
        
        Este texto contiene las Condiciones Generales que regulan el uso de la Plataforma por parte de los negocios que tengan una cuenta en MOYO y las personas que utilizan dicha cuenta en nombre de los mismos (en adelante, las Marcas y los Usuarios, respectivamente).
        
        Para cualquier duda, o sugerencia, puede enviarnos un correo electrónico a la siguiente dirección: sos@MOYO.com.`
  },
  {
    titulo: "Condiciones Generales de Contratación",
    texto: `
        <h4>Partes</h4>
        De un lado, SOCIAL NETWORK MOYO, S.A. con NIF A87532826 (en adelante, MOYO o la Titular, indistintamente), y domicilio en Calle Leganitos 47, 4º, 28013, Madrid, titular del sitio web accesible a través de la URL https://business.MOYO.com/ (en adelante, el Sitio Web) y, de otra, el Comprador, entendido como cualquier Marca que disponga de una cuenta en el Sitio Web, creada y gestionada por una persona física mayor de edad conforme a la legislación española, que accederá al Sitio Web representación de la Marca, completando los pasos allí establecidos para la contratación del servicio MOYO Business, incluida la aceptación de estas Condiciones.
        
        <h4>Objeto</h4>
        El objeto de las presentes Condiciones Generales de Contratación (CGC) es regular la contratación por parte de la Marca del servicio de contratación de MOYO Business, que permitirá que las promociones y otro contenido publicado por la Marca goce de una mayor visibilidad en la Plataforma MOYO, a cambio de la contraprestación económica que corresponda.
        
        <h4>Proceso de contratación</h4>
        El proceso de contratación comienza en el momento de la validación por MOYO de la Marca solicitada. En caso de ser denegada la validación, la Marca no se hará pública y será eliminada.
        ...
        Cuando en la Web se establezca ofertas y descuentos por campañas promocionales, simultáneamente a su contratación MOYO procederá a notificar al Usuario las condiciones aplicadas.
        ...
        MOYO confirmará haber recibido la voluntad de contratar del Comprador y, en su caso, también confirmará el pago. En su caso, remitirá por correo electrónico la correspondiente factura. Con la aceptación de estas (CGC) el Comprador consiente el envío de factura electrónica.
        ...
        <h4>Modalidades MOYO Business</h4>
        ...
        Una vez recibido el pago por parte de MOYO, se pondrá a disposición del Comprador el servicio Premium contratado. Hasta el momento que el pago no se haga efectivo, MOYO se reserva el derecho de no prestar el servicio solicitado.
        ...
        La Marca podrá contratar el servicio MOYO Business Premium viéndose el precio afectado según el número de establecimientos registrados.
        
        <h4>Eliminación de la Marca</h4>
        Cuando la cuenta de Marca sea eliminada de MOYO Business, en caso de que no se haya agotado el crédito o período Premium contratado, el Comprador y en concreto la Marca no tendrá derecho de reembolso o devolución del importe en metálico.
        ...
        Dada la naturaleza del servicio y la condición de no consumidor de la Marca, no se aplicará derecho de desistimiento alguno respecto de la contratación del servicio MOYO Business Premium.
        
        <h4>Obligaciones de las partes</h4>
        Obligaciones de MOYO
        En virtud de estas CGC, MOYO se compromete a:
        ...
        Pagar en tiempo y forma las cantidades correspondientes, incluyendo tasas, impuestos y cualesquiera otros costes especificados durante el proceso de compra. La falta de pago, cuando ésta no tuviera lugar en el último paso del proceso de compra eximirá a MOYO del cumplimiento de sus obligaciones.
        Responder de la autenticidad y precisión de cualesquiera datos hayan sido facilitados para realizar la contratación.
        Asumir la responsabilidad derivada de no cumplir los requisitos exigidos por MOYO para ostentar la condición de Comprador o de la no posesión de la documentación requerida para realizar el pedido.
        ...
        La Marca (entendiéndose incluidos a estos efectos todos los Usuarios que accedan a través de su cuenta como gestores de la Marca, o bien de uno o varios puntos de venta de la misma) deberá cumplir lo dispuesto en las presentes CGU en cuanto a la protección de datos personales de los usuarios registrados en MOYO.
        
        La Marca podrá acceder a los datos de los usuarios particulares que tengan una cuenta personal en MOYO (en el presente apartado se les denominará “interesados”), siempre que éstos estuvieran publicados en su perfil, a menos que se les diera la posibilidad de restringir la accesibilidad de su perfil configurando su cuenta como privada.
        
        Obligaciones de la Marca
        Los datos de los interesados, publicados en su perfil personal, son accesibles por la Marca exclusivamente en el ámbito de la Plataforma MOYO, quedando prohibido su tratamiento para fines distintos al uso dentro de la Plataforma.
        
        La Marca se abstendrá de tratar los datos de los interesados registrados en MOYO para fines distintos a aquellos para los que los interesados hubieran otorgado su consentimiento. Por tanto, la Marca sólo podrá tratar los datos a través de su cuenta de MOYO business, para los siguientes fines:
        
        Ser seguidor del interesado en la Plataforma MOYO.
        Siempre que el interesado sea seguidor de la Marca, enviarle a su cuenta personal en MOYO información sobre sus productos y/o servicios, descuentos, ofertas y otras promociones.
        Siempre que el interesado sea seguidor de la Marca, enviarle a su cuenta personal en MOYO información sobre sus productos y/o servicios, descuentos, ofertas y otras promociones personalizadas, en función de las características del interesado seguidor (localización, franja de edad, sexo e intereses indicados en su perfil).
        En caso de que la Marca contratara el servicio a MOYO previo pago, ésta podrá enviar a los interesados publicidad sobre sus productos y servicios a través de la Plataforma, independientemente de que fueran o no seguidores. No obstante, este tratamiento se regulará en las condiciones de contratación correspondientes.
        La Marca no podrá tratar los datos personales de los interesados para crear bases de datos o de cualquier otro modo exportarlos fuera de la Plataforma MOYO. Tampoco podrá comunicarse con los interesados fuera de la Plataforma, quedando prohibido el envío de comunicaciones comerciales, salvo que éstos le dieran su consentimiento explícito a la Marca.
        ...
        Igualmente, si el interesado comunica a la Marca, bien directamente bien mediante la Plataforma de MOYO, o de cualquier otro modo revoca su consentimiento para el envío de mensajes a su cuenta personal de MOYO, la Marca se abstendrá de enviarle dichas comunicaciones, incluyendo las promocionales de cualquier tipo.
        
        Responsabilidad
        MOYO no se hace responsable de los incumplimientos y/o negligencias en que incurra la Marca respecto a las presentes CGU o la normativa vigente en materia de protección de datos./p>
        
        La Marca asume toda la responsabilidad que pudiera irrogarse a MOYO, a quien mantendrá indemne, como consecuencia de cualquier tipo de sanciones administrativas impuestas por las autoridades correspondientes, así como de los daños y perjuicios por procedimientos judiciales o extrajudiciales contra MOYO, como consecuencia de cualquier incumplimiento culposo o doloso de sus obligaciones contractuales o legales de protección de datos. Quedan incluidos en esta garantía todos los casos gastos por minutas de abogado, procurador y cualesquiera otros profesionales, considerándose asimismo causa suficiente para instar por MOYO la resolución de las presentes CGU y, por tanto, la suspensión o eliminación de la Marca.
        ...
        MOYO en ningún caso será responsable de los daños y perjuicios que se causen al Comprador por causas imputables a éste.
        
        MOYO será responsable exclusivamente de los daños y perjuicios que se causen al Comprador como consecuencia de las contrataciones realizadas a través del Sitio Web, cuando se deriven de una actuación dolosa de aquél.
        
        A título meramente enunciativo y sin ánimo de exhaustividad, MOYO no será responsable de:
        ...
        El Comprador declara que los servicios objeto de contratación lo son bajo su propio riesgo y ventura, limitándose la actividad de Publicar a la ejecución de las tareas materiales necesarias para hacerle llegar aquellos productos que hubiera seleccionado. En ningún caso MOYO es responsable de la elección de los servicios efectuada por el Comprador, incluso aunque MOYO le haya asesorado al respecto, y de la falta de diligencia de éste a la hora de comprobar las especificaciones de los productos objeto de pedido.
        
        En cualquier caso, la responsabilidad que asume MOYO frente al Comprador, en ningún caso incluye el lucro cesante y se limitará, en cualquier caso, como máximo y por cualquier concepto, al importe total percibido por MOYO del Comprador conforme a la estipulación sobre condiciones económicas de las presentes Condiciones.
        
        <h4>Indemnización</h4>
        El incumplimiento por parte del Comprador de las presentes CGC o de cualesquiera otras que resultaran aplicables puede suponer daños y perjuicios para MOYO. En este sentido, el Comprador estará obligado a resarcir a aquél de cualquier daño, perjuicio, pérdida o coste (como pueden ser los honorarios de abogados y procuradores).
        
        Asimismo, si por los incumplimientos del Comprador se generaran cualquier tipo de reclamaciones o procedimientos contra MOYO, aquél deberá dejar a MOYO indemne de los mismos, pudiendo éste reclamarle cualquier gasto, coste, daño o perjuicio derivado de los mismos.
        
        Modificaciones
        MOYO y las presentes CGC pueden, en cualquier momento y sin necesidad de previo aviso, ser actualizadas y/o modificadas.
        ...
        Las presentes CGC, las Condiciones Particulares aceptadas en cada momento y cualesquiera otras condiciones aplicables al Comprador constituyen un acuerdo único entre el Comprador y MOYO.
        ...
        MOYO podrá ceder o delegar total o parcialmente y de forma totalmente libre sus derechos y obligaciones contenidas en estas Condiciones sin necesidad de aviso previo. MOYO también podrá sustituir por cualquier negocio jurídico al titular de esta relación jurídica por cualquier otra.
        ...
        Legislación y fuero
        Las relaciones entre MOYO y el Comprador surgidas como consecuencia de la aceptación de las presentes Condiciones se regirán por la legislación y jurisdicción españolas.
        
        Para la resolución de las discusiones o conflictos acaecidos entre MOYO y el Comprador, toda vez que este no ostenta la condición de consumidor ni usuario, ambos se someterán, con renuncia expresa a cualquier otro fuero que pudiera corresponderles, a los Juzgados y Tribunales de la Villa de Madrid.`
  }
];
